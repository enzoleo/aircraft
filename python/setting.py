...
class AircraftWar:
    """This class only contains static members. Somehow you can consider
    it as something like a namespace. Everything defined here is actually
    associated to the system settings of the game.

    To better control the hyperparameters you may encounter in designing
    this game, just feel free to edit them as you like.
    """
    # Default window size.
